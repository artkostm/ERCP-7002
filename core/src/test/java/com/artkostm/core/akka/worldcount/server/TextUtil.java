...
{
    public static List<Word> evaluateExpression(final String line) 
    {
    ...
    public static final String[] STOP_WORDS = { "a", "about", "above", "above", "across", "after",
    ...
    public static final List<String> STOP_WORDS_LIST = Arrays.asList(TextUtil.STOP_WORDS);
}
